 ...
 * @return {Object} - this
 */
function _slikColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_slikColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_slikColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_slikColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _slikColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function slikColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _slikColor( backgroundColor, accentHue );
